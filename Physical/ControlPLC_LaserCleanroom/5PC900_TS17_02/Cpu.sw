...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  ...
  <TaskClass Name="Cyclic#2">
    <Task Name="VFLCR_Alar" Source="ProcessControl.VFLCR.VFLCR_Alarm.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="VFLCR_Ope0" Source="ProcessControl.VFLCR.VFLCR_Operation.prg" Memory="UserROM" Description="VF-LCR0 Operations" Language="IEC" Debugging="true" />
    <Task Name="VFLCR_Ope1" Source="ProcessControl.VFLCR.VFLCR_Operation.prg" Memory="UserROM" Description="VF-LCR1 Operations" Language="IEC" Debugging="true" />
    <Task Name="VFLCR_Ope2" Source="ProcessControl.VFLCR.VFLCR_Operation.prg" Memory="UserROM" Description="VF-LCR2 Operations" Language="IEC" Debugging="true" />
    <Task Name="VFLCR_Ope3" Source="ProcessControl.VFLCR.VFLCR_Operation.prg" Memory="UserROM" Description="VF-LCR3 Operations" Language="IEC" Debugging="true" />
  ...
  <TaskClass Name="Cyclic#4">
    ...
    <Task Name="LaserGen3S" Source="Automation.LaserGen3SFC.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="SFCControl" Source="Automation.SFCControl.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="VFLCR_Syst" Source="ProcessControl.VFLCR.VFLCR_System.prg" Memory="UserROM" Description="VF-LCR System Control" Language="IEC" Debugging="true" />
    <Task Name="MachineMod" Source="MachineControl.MachineMode.MachineMode.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Gen3Python" Source="ProcessControl.VFLCR.Gen3PythonLaserCalibration.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Safety" Source="MachineControl.Safety.Safety.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="TempSensor" Source="ProcessControl.OpticsBox.TempFlowSensors.prg" Memory="UserROM" Language="IEC" Debugging="true" />
  </TaskClass>
  <TaskClass Name="Cyclic#5" />
  <TaskClass Name="Cyclic#6" />
  <TaskClass Name="Cyclic#7" />
  <TaskClass Name="Cyclic#8">
    <Task Name="VFLCR_Pixe" Source="ProcessControl.VFLCR.VFLCR_PixelMapping.prg" Memory="UserROM" Language="IEC" Debugging="true" />
