define([
    ...
    function renewSvgContainer($svgContainer, concatenation) {
        ...
        var dimensions = this.widget.el.css(['width', 'height']);
        var elemWidth = parseInt(dimensions.width, 10),
            elemHeight = parseInt(dimensions.height, 10);
        this.widget._setViewBoxDimensions(elemWidth, elemHeight);
